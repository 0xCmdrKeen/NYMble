...
`;
    ...
    switchChannel(channel, geohash = '') {
        ...
        if (geohash && geohash !== '') {
            ...
            if (location) {
                fullTitle = `${displayName} <br/>
                    <font size="2" style="color: var(--text-dim); text-shadow:none;">
                        <a style="color: var(--text-dim); text-shadow:none;"
                           href="https://www.geohash.es/decode?geohash=${geohash}"
